...
class TrainEigenFaces:
    def __init__(self):
        ...
        if not os.path.isdir(self.path):
            os.mkdir(self.path)
        self.model = cv2.createEigenFaceRecognizer(15, 3500)
        ...
        if self.count_captures < NUM_TRAINING:
            ...
            if len(faces) > 0:
                ...
                if self.count_timer%FREQ_DIV == 0:
                    ...
                    print("Captured image: " + str(self.count_captures) + ", (" + str(gray.shape[1]) + "," + str(gray.shape[0]) + ")")
    ...
    def eigen_train_data(self):
        ...
        self.model.save('eigen_trained_data.yml')
